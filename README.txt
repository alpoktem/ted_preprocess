...
To collect all data from talks into one corpus with sequences of size 50, partitioned into training (0.7 of samples), testing, development sets with word vocabulary (with minimum word occurence 1) and testing file as text:

python corpusMaker.py -i sample_ted_eachtalk -o sample_ted_punc_data -r 0.7 -v 1 -t
